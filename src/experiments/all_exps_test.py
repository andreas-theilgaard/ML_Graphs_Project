...
if __name__ == "__main__":
    ...
    # for shallow_embedding in shallow_embeddings:
    #     subprocess.call(f"{CONFIG_SETUP} model_type='GNN' runs=1 dataset.GNN.extra_info={shallow_embedding} dataset.GNN.model='GraphSage' dataset.GNN.training.epochs=10",shell=True)
