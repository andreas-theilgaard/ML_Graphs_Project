...
def fit_combined2_class(config, dataset, training_args, Logger, log, seeds, save_path):
    ...
    for counter, seed in enumerate(seeds):
        ...
        shallow = create_and_fit_shallow(data=data, dataset=dataset, split_idx=split_idx)
        ...
        evaluator = METRICS(metrics_list=config.dataset.metrics, task="NodeClassification")
